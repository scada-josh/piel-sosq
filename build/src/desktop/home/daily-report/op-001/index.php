...
<!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>MIS - Daily Report - OP001</title>
        ...
        <link href="../../../../../stylesheets/stylesheet-desktop-home-dailyReport-op001.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BREADCRUMBS -->
                            ...
                            <div class="page-content-inner">
                                                                ...
                                                                <div class="row margin-bottom-40  iel-mis-prototype">
                                    <div class="col-md-12">
                                     <!--    <h1>KPI</h1>
                                        <h2>OP001 - รถ</h2> -->
                                        <!-- <button type="button" class="btn btn-danger" id="btn-show-prototype">ตัวอย่างหน้าจอ (Prototype)</button> -->
                                       <!--  <button type="button" class="btn btn-danger">Prototype</button>
                                        <button type="button" class="btn btn-danger">BPMN</button> -->
                                    </div>
                                </div> 
    ...
    <div class="page-wrapper-row">
        ...
        <script src="../../../../../javascripts/javascript-desktop-home-dailyReport-op001.js" type="text/javascript"></script>
